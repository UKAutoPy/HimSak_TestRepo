...
class LoginPage(BasePage):
    ...
    enter_password_field_id = "input-password"
    login_button_xpath = "//input[@value = 'Login']"
    warning_message_xpath = "//div[text() = 'Warning: No match for E-Mail Address and/or Password.']"
    ...
    def enter_password(self, password_text):
        self.type_into_element(password_text, "enter_password_field_id", self.enter_password_field_id)
